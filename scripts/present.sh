...
sed -i '87s/80/90/g' feeds/luci/applications/luci-app-openclash/luasrc/controller/openclash.lua
sed -i '87 i\	entry({"admin", "services", "openclash", "editor"}, template("openclash/editor"),_("Config Editor"), 80).leaf = true' feeds/luci/applications/luci-app-openclash/luasrc/controller/openclash.lua
